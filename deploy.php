...
$allowed_ips = array(
    '2606:50c0::', '2a0a:a440::', '143.55.64.', '140.82.112.', '185.199.108.', '192.30.252.', // GitHub
    '195.37.139.','205.164.154.130' // VZG
);
$allowed = true;
...
if (!$allowed) {
    ...
    echo "<span  >Sorry, no hamster - better convince your parents!  </span>";
...
foreach($commands AS $command){
    ...
    // Output
    $output .= "<span >$</span> <span >{$command}n</span>";
